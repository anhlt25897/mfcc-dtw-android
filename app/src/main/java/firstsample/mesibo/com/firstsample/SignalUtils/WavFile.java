package firstsample.mesibo.com.firstsample.SignalUtils;
...
public class WavFile {
    ...
    private double numFrames;                    // Number of frames within the data section
    ...
    public double getFramesRemaining() {
    ...
    public static WavFile openWavFile(File file) throws IOException, WavFileException {
        ...
        while (true) {
            ...
            if (chunkID == FMT_CHUNK_ID) {
                ...
                wavFile.numFrames = (float) chunkSize / wavFile.blockAlign;
